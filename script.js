...
const clickStatus=[false,false,false,false];

const faqElements=document.querySelectorAll('.faq-area');

faqElements.forEach((value,index) => {
    value.querySelector('header').addEventListener('click',(event) => {
        const svgContainer=value.querySelector('.plus-icon');
